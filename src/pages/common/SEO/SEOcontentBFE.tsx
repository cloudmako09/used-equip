...
const SEO_BFE: types_seoData[] = [
  {
    ...
    FR: {
      ...
      Meta:
        "Chez Location d’équipement Battlefield, vous trouverez le plus grand inventaire d’équipement usagé Cat dans l’est du Canada. Que ce soit pour des applications de construction, de pavage, de concassage ou forestières, notre sélection d’équipement offre une valeur accrue et une performance inégalée dans tous les types d’environnements. Location d’équipement Battlefield est votre concessionnaire Caterpillar autorisé au Manitoba, en Ontario, au Québec, au Nouveau-Brunswick, en Nouvelle-Écosse, à l’Île-du-Prince-Édouard, à Terre-Neuve et Labrador et au Nunavut.",
      Desc:
        "Chez Location d’équipement Battlefield, vous trouverez le plus grand inventaire d’équipement usagé Cat dans l’est du Canada. Que ce soit pour des applications de construction, de pavage, de concassage ou forestières, notre sélection d’équipement offre une valeur accrue et une performance inégalée dans tous les types d’environnements. Location d’équipement Battlefield est votre concessionnaire Caterpillar autorisé au Manitoba, en Ontario, au Québec, au Nouveau-Brunswick, en Nouvelle-Écosse, à l’Île-du-Prince-Édouard, à Terre-Neuve et Labrador et au Nunavut.",
      ExtraText: null,
    },
  },
  {
    ...
    EN: {
      ...
      Meta:
        "Operational efficiency is maximized thanks to our rock-solid selection of used articulated trucks. Our dump trucks are ultra-tough, offering unmatched performance and traction control on rough or uneven terrain.",
      Desc: (
        <>
          <h2>Used Articulated Trucks – Built to Last!</h2>
          <p>
            Does your construction site require an ultra-tough, reliable and
            cost-effective dump truck? Look no further than Battlefield
            Equipment Rentals's extensive selection of used articulated trucks!
            Regardless of the heavy materials you need to haul or your project's
            budget, Battlefield Equipment Rentals has the used dump truck to
            meet your specific needs and get the job done right!
          </p>
      ...
      ExtraText: (
        <>
          ...
          <p>
            From Nova Scotia to Nunavut, Battlefield Equipment Rentals has a
            wide selection of used articulated trucks that are ready to get to
            ...
            traction control system. Battlefield Equipment Rentals used
          ...
          <br />
          <h5>
            Get Your Used Articulated Truck from Battlefield Equipment Rentals
            Today!
          </h5>
          <p>
            Experience how much faster and cheaper you can get your hauling done
            with a used articulated truck from Battlefield Equipment Rentals!
            Caterpillar's used dump trucks are built to last and always get the
            job done right! Discover the difference a Caterpillar dump truck can
            make on your site! Contact us today for more information about our
            used articulated trucks or to get a quote for your next project!
          </p>
          <p>
    ...
    FR: {
      ...
      Meta:
        "L’efficacité opérationnelle est maximisée grâce à notre sélection solide de tombereaux articulés usagés. Nos tombereaux sont ultra robustes, fournissant une performance accrue et un superbe contrôle de traction sur terrain rugueux ou accidenté.",
      Desc: (
        <>
          <h2>TOMBEREAUX ARTICULÉS USAGÉS</h2>
          <p>
            Est-ce que vous avez besoin d’un tombereau résistant, fiable et
            rentable? Nous avons chez Location d’équipement Battlefield un choix
            étendu de tombereaux articulés usagés! Peu importe les matériaux
            lourds que vous devez transporter ou le budget de votre projet,
            Location d’équipement Battlefield a le camion articulé usagé qui
            répondra à vos besoins spécifiques et fera le travail correctement!
          </p>
        </>
      ),
      ExtraText: (
        <>
          ...
          <p>
            De la Nouvelle-Écosse au Nunavut, Location d’équipement Battlefield
            a une vaste sélection de tombereaux articulés usagés prêts à se
            mettre au travail! Nos tombereaux articulés usagés sont durables et
            capables de manipuler des charges utiles allant de 26,5 tonnes à
            ...
            supérieur. Les tombereaux articulés usagés Location d’équipement
            Battlefield contiennent également des technologies et des
          ...
          <br />
          <h5>
            Achetez votre tombereau articulé usagé chez Battlefield Equipment
            Rentals dès aujourd'hui!
          </h5>
          <p>
            ...
            Location d’équipement Battlefield! Les tombereaux articulés usagés
            de Caterpillar sont construits pour durer et toujours bien faire le
            travail! Faites la différence sur votre chantier avec un tombereau
            articulé Caterpillar! Contactez-nous dès aujourd'hui pour plus
            d'information sur nos tombereaux articulés usagés ou pour obtenir un
  ...
  },
  {
    ...
    EN: {
      ...
      Meta:
        "Our used Backhoe Loaders are a must-have for a variety of tasks, such as general construction, demolitions and excavations, landscaping, asphalt breaking and road paving.",
      Desc: (
        <>
          ...
          <p>
            ...
            durability to handle any terrain? Battlefield Equipment Rentals
      ...
      ExtraText: (
        <>
          ...
          <br />
          <h5>
            Get Your Used Backhoe Loader from Battlefield Equipment Rentals
            Today!
          </h5>
          <p>
            ...
            Caterpillar! Battlefield Equipment Rentals has a wide selection of
            used Caterpillar backhoe loaders that come Caterpillar Certified,
    ...
    FR: {
      Name: "Rétrocaveuses",
      Meta:
        "Nos rétrocaveuses usagées à vendre sont indispensables pour une variété de travaux. Grâce à leur châssis compact, nos pépines d’occasion peuvent aller n’importe où, ce qui en fait un choix populaire pour les projets d’ingénierie ou de construction qui nécessitent une performance supérieure.",
      Desc: (
        <>
          ...
          <p>
            ...
            n’importe quel terrain? Location d’équipement Battlefield offre une
            vaste sélection de pépines usagées pour vous aider à compléter votre
            projet à temps et en deçà du budget!
          </p>
        </>
      ),
      ExtraText: (
        <>
          ...
          <br />
          <h4>
            Achetez votre pépine usagée chez Location d’équipement Battlefield
            dès aujourd’hui!
          </h4>
          <p>
            ...
            et qui creuse partout, choisissez un Cat®! Location d’équipement
            Battlefield a une vaste sélection de pépines usagées qui peuvent
            être certifiées Caterpillar, et dont les prix commencent à 20 000 $
            CAD. Contactez-nous aujourd’hui pour obtenir plus d’informations sur
            nos rétrocaveuses usagées ou demander un devis pour votre prochain
            projet!
          </p>
        </>
      ),
  ...
  },
  {
    ...
    EN: {
      Name: "Compactors",
      Meta:
        "Battlefield Equipment Rentals’ Industrial Compactors feature advanced technologies that boost durability, operational performance and efficacy.",
      ExtraText: (
        <>
          ...
          <p>
            ...
            Pointe-Claire, Battlefield Equipment Rentals has the used compactor
            you need! Our used compactors are affordable (starting at $13,500
            CAD) and many come Caterpillar Certified.{" "}
          </p>
          <br />
          <h5>
            Get Your Used Compactor from Battlefield Equipment Rentals Today!
          </h5>
          <p>
            If your landfill, agricultural or construction site needs a
            compactor, choose a used Caterpillar compactor from Battlefield
            Equipment Rentals! We carry a wide selection of compactors (soil,
            vibratory soil and landfill) and rollers (pneumatic and tandem
            vibratory) that are affordable, cost-effective and backed by
      ...
      Desc: (
        <>
          ...
          <p>
            ...
            rollers, Battlefield Equipment Rentals has the used Caterpillar
    ...
    FR: {
      Name: "Compacteurs",
      Meta:
        "Les compacteurs d’occasion de Location d’équipement Battlefield sont dotés de technologies avancées qui augmentent la durabilité, la performance et l’efficacité pour optimiser votre productivité sur le chantier. Nos rouleaux compacteurs usagés offrent un maximum de valeur pour tous vos besoins.",
      Desc: (
        <>
          ...
          <p>
            ...
            d’un rouleau vibrant, Location d’équipement Battlefield a le
      ...
      ExtraText: (
        <>
          ...
          <p>
            ...
            compacteur de décharge à Pointe-Claire, Battlefield Equipment
            Rentals a le compacteur usagé fait pour vous! Nos compacteurs usagés
            sont abordables (ils sont offerts à partir de 13 000 $ CAD) et
            peuvent être certifiés Caterpillar.
          </p>
          <br />
          <h5>
            Obtenez votre compacteur usagé chez Location d’équipement
            Battlefield dès aujourd’hui!{" "}
          </h5>
          <p>
            ...
            Location d’équipement Battlefield! Nous offrons une vaste sélection
            de compacteurs et de rouleaux mixtes abordables, rentables et
            garantis par Caterpillar. Contactez-nous aujourd’hui pour obtenir
  ...
  },
  {
    ...
    EN: {
      ...
      Meta:
        "Whether processing raw materials, mining sand or handling glass in recycling applications, our used industrial crushing equipment will boost productivity and improve your bottom line.",
      ExtraText: (
        <>
          <h4>Wide Range of Used Crushers and Screens </h4>
          <p>
            Battlefield Equipment Rentals carries a wide range of used crushers
            and screens for applications in the mining, quarry and recycling
            industries. Whether your job site requires fine grinding of stone,
            glass or other materials, Battlefield Equipment Rentals will have
            the used crusher to meet your needs. The used screenrs we carry are
            able to process and effectively screen construction, demolition,
            soil and recycling debris. Battlefield Equipment Rentals’s lineup of
            used crushers and screens includes well-known, trusted and reliable
            brands such as Lokotrack, Masaba, Metso and Nordberg CVB. If you
            need a used crusher and screen for your job site, contact
            Battlefield Equipment Rentals today for more information or a quote!{" "}
          </p>
        </>
      ),
    },
    FR: {
      ...
      Meta:
        "Que vous traitiez des matières premières, du sable, ou du verre dans des applications de recyclage, nos concasseurs et nos cribles usagés à vendre augmenteront votre productivité et amélioreront votre rentabilité.",
      Desc: (
        <>
          <h2>
      ...
      ExtraText: (
        <>
          ...
          <p>
            Location d’équipement Battlefield offre une vaste gamme de cribles
            et de concasseurs usagés pour des applications dans les industries
            minières, de carrières et de recyclage. Que votre chantier nécessite
            de l’équipement pour broyer des pierres, du verre ou d’autres
            matériaux, vous pouvez compter sur Location d’équipement Battlefield
            pour répondre à vos besoins. Les cribles d’occasion que nous offrons
            sont capables de traiter et de filtrer efficacement les débris de
            construction, de démolition, de sol et de recyclage. La sélection de
            cribles et de concasseurs usagés de Location d’équipement
            Battlefield est composée de marques fiables et connues telles que
            Lokotrack, Masaba, Metso et Nordberg CVB. Si vous avez besoin d’une
            crible ou d’un concasseur usagé, contactez Location d’équipement
            Battlefield aujourd’hui pour obtenir un devis ou plus d’information.
          </p>
        </>
      ),
    },
  },
  {
    ...
    EN: {
      Name: "Excavators",
      Meta:
        "Excavators are an indispensable asset to any contractor’s fleet. Whatever the application, our selection of used excavators can get the job done safely and efficiently. A digger’s purpose is almost limitless thanks its exceptional speed, energy efficiency and lifting capacity.",
      Desc: (
        <>
          <h2>Used Cat excavators to help you dig up the profits! </h2>
          <p>
            Whatever the application, Battlefield Equipment Rentals’ selection
            of used excavators can get the job done safely and efficiently. When
            you choose to buy used excavators, you are obtaining the absolute
            best machines for the job. Our used excavators offer limitless
            capabilities including exceptional speed, fuel efficiency and
            digging performance. Thanks to their rock-solid frames and robust
            components, our used mini hydraulic excavators provide unrivaled
            strength, durability and reliability on the most challenging
            terrain. From digging trenches and foundations, to post holes and
            breaking concrete, you can count on Battlefield Equipment Rentals’
            used mini hydraulic excavators to perform with unsurpassed power and
            agility.
          </p>
      ...
      ExtraText: (
        <>
          <h4>
            Battlefield Equipment Rentals’ wide selection of used excavators{" "}
          </h4>
          <p>
            Battlefield Equipment Rentals used excavators are equipped with a
            long, heavy-duty undercarriage that offers greater stability when
            ...
            Battlefield Equipment Rentals’ used excavators for sale enable you
            dominate the job site with ease, comfort and security.
          </p>
        </>
      ),
    },
    FR: {
      Name: "Excavatrices",
      Meta:
        "Les excavatrices usagées à vendre de Location d’équipement Battlefield sont un atout indispensable pour la flotte d’un entrepreneur. Quelle que soit l’application, notre sélection de pelles hydrauliques d’occasion fera en sorte que le travail sera accompli avec efficacité et en toute sécurité.",
      Desc:
        "Les excavatrices usagées à vendre de Location d’équipement Battlefield sont un atout indispensable pour la flotte d’un entrepreneur. Quelle que soit l’application, notre sélection de pelles hydrauliques d’occasion fera en sorte que le travail sera accompli avec efficacité et en toute sécurité. Grâce à leur vitesse, leur rendement énergétique et à leur puissance de levage exceptionnelle, Il n’y a pas de limites aux travaux que nos pelles mécaniques peuvent accomplir. Le châssis et les composants robustes de nos pelles sur chaines et nos pelles sur pneus offrent une puissance et une fiabilité supérieures sur les terrains difficiles et dans les environnements rigoureux. Que vous creusiez des tranchées ou des fondations, ou que vous faisiez du paillage forestier ou des travaux miniers, vous pouvez compter sur les excavatrices usagées de Location d’équipement Battlefield pour vous fournir une agilité, une productivité et une performance inégalés.",
      ExtraText: (
        <>
          <h4>
            La vaste sélection d’excavatrices usagées de Location d’équipement
            Battlefield
          </h4>
          <p>
            Les excavatrices usagées de Location d’équipement Battlefield sont
            équipées d’un châssis robuste qui offre une stabilité supérieure
            pendant le transport d’objets lourds, ce qui augmente la
            ...
            d’occasion de Location d’équipement Battlefield vous permettent de
            maîtrise le chantier avec facilité, confort et sécurité.{" "}
          </p>
        </>
      ),
    },
  },
  {
    ...
    EN: {
      ...
      Meta:
        "Battlefield Equipment Rentals’ used forestry machines will satisfy your toughest application needs. Our commercial logging equipment provide increased stability on steep ground, fuel economy, efficient swing power and maximized visibility.",
      Desc: (
        <>
          <h2>Battlefield Equipment Rentals’ Used Forestry Machines </h2>
          <p>
            Battlefield Equipment Rentals’ used forestry machines will satisfy
            your toughest application needs. Our commercial logging equipment
            provide increased stability on steep ground, fuel economy, efficient
            swing power and maximized visibility. Our varied inventory of feller
            bunchers, forwarders and skidders is your top pick for harvesting,
            extracting and loading goods on major projects, such as road
            building, lumber and reforestation.
          </p>
      ...
      ExtraText: (
        <>
          ...
          <p>
            Battlefield Equipment Rentals carries a selection of used forestry
            machines than can help complete your commercial logging needs. Our
            used forestry inventory includes feller bunchers, forwarders and
            skidders to meet your extracting, harvesting and loading needs.
            Caterpillar forestry machines are reliable, easy to maintain and
            provide increased stability and visibility on your jobsite. Our
            forestry machines are also powerful, ranging in net flywheel power
            from 149 HP to 291 HP. If your land management, logging or mill yard
            needs require rugged, purpose-built equipment to get the job done,
            contact Battlefield Equipment Rentals today about our used forest
            machines.
          </p>
        </>
      ),
    ...
    FR: {
      ...
      Meta:
        "Les machines forestières d’occasion de Location d’équipement Battlefield sauront satisfaire à vos besoins les plus ardus. Notre équipement d’exploitation forestière usagé fournit une superbe stabilité sur le terrain escarpé, une bonne économie de carburant, une visibilité maximisée et une puissance d’oscillation efficace.",
      Desc:
        "Les machines forestières d’occasion de Location d’équipement Battlefield sauront satisfaire à vos besoins les plus ardus. Notre équipement d’exploitation forestière fournit une superbe stabilité sur le terrain escarpé, une bonne économie de carburant, une visibilité maximisée et une puissance d’oscillation efficace. Notre inventaire varié d’abatteuses-groupeuses, de porteurs et de débardeurs usagés à vendre sont votre meilleur choix pour vos travaux d’extraction, de récolte ou de chargement de marchandise sur des projets majeurs de construction de route, d’exploitation forestière ou de reboisement.",
      ExtraText: (
        <>
          <h4>Des machines forestières usagées pour tout type de projet</h4>
          <p>
            Location d’équipement Battlefield offre une sélection de produits
            forestiers usagés conçus pour répondre à tous vos besoins en matière
            d’exploitation forestière commerciale. Notre inventaire d’équipement
            forestier usagé, qui comprend des abatteuses-groupeuses, des
            porteurs et des débadeurs, vous permet d’accomplir tous vos travaux
            d'extraction, de récolte et de chargement. Les machines forestières
            Caterpillar sont fiables, faciles à entretenir et fournissent une
            stabilité et une visibilité supérieures sur le chantier. Notre
            équipement forestier est aussi très puissant, offrant une puissance
            d’inertie de 149 HP à 291 HP. Si vous nécessitez un équipement
            robuste et spécialement conçu pour vos travaux forestiers, contactez
            Location d’équipement Battlefield aujourd’hui pour obtenir plus
            d’information sur nos machines forestières d'occasion.
          </p>
        </>
      ),
    },
  },
  {
    ...
    EN: {
      Name: "Forklifts",
      Meta:
        "Safety, comfort and lifting capacity are just some of the features that make up a great Forklift. With Toromont Material Handling’s used lift trucks, you can easily cut costs and optimize your logistical operations.",
      Desc:
        "Safety, comfort and lifting capacity are just some of the features that make up a great forklift. With Toromont Material Handling’s used lift trucks, you can easily cut costs and optimize your logistical operations. Our diesel and electric forklifts are robust, durable, powerful and comfortable to operate, helping to minimize downtime for higher productivity and cost efficiency. Whatever the industry, we have a solution for all of your material handling needs.",
      ExtraText: null,
    },
    FR: {
      Name: "Chariots Elévateurs",
      Meta:
        "Un bon chariot élévateur doit posséder des caractéristiques supérieures en termes de sécurité, de confort et de capacité de levage. Avec les chariots élévateurs usagés de Toromont Manutention, vous pouvez facilement réduire et optimiser vos coûts d’opérations logistiques.",
      Desc:
        "Un bon chariot élévateur doit posséder des caractéristiques supérieures en termes de sécurité, de confort et de capacité de levage. Avec les chariots élévateurs usagés de Toromont Manutention, vous pouvez facilement réduire et optimiser vos coûts d’opérations logistiques. Nos chariots élévateurs électriques et à combustion sont robustes, durables, puissants et confortables, permettant de réduire vos temps d’arrêt pour une plus grande productivité et une meilleure rentabilité. Quel que soit l’industrie, nous avons une solution pour tous vos besoins en matière de manutention.",
      ExtraText: null,
    },
  },
  {
    ...
    EN: {
      ...
      Meta:
        "To navigate the notoriously rigorous terrain and harsh environment that is common to the mining industry, you need Battlefield Equipment Rentals’ used mining equipment. Our selection of used mining equipment will optimize your operations by delivering value and heavy-duty performance.",
      Desc: (
        <>
          ...
          <p>
            ...
            that is common to the mining industry, you need Battlefield
            Equipment Rentals’s used mining equipment. Our selection of used
      ...
      ExtraText: (
        <>
          ...
          <p>
            Battlefield Equipment Rentals carries the mining industry’s largest
            and most advanced lineup of used mining equipment for surface mining
            applications. Whether your mining site requires digging, drilling,
            hauling or moving, Battlefield Equipment Rentals has the used mining
            equipment, loading tools and commercial mining vehicles needed to
            get the job done. Caterpillar’s used mining equipment is renowned
            for its efficiency, excellent traction and rigidity to help you move
            your materials faster. Contact Battlefield Equipment Rentals today
            for more information about our used mining equipment!
          </p>
        </>
      ),
    },
    FR: {
      ...
      Meta:
        "Pour naviguer sur le terrain rigoureux et difficile qui est commun à l’industrie minière, il vous faut l’équipement minier usagé de Location d’équipement Battlefield. Notre sélection d’équipements miniers améliorera vos opérations en livrant une performance de longue durée.",
      Desc:
        "Pour naviguer sur le terrain rigoureux et difficile qui est commun à l’industrie minière, il vous faut l’équipement minier usagé de Location d’équipement Battlefield. Notre sélection d’équipements miniers améliorera vos opérations en livrant une performance de longue durée et une valeur supérieure. Nos machines sont dotées de technologies avancées et de composants de qualité qui fournissent une superbe traction, une plus grande durabilité et une puissance hydraulique exceptionnelle. Grâce à nos véhicules miniers commerciaux, vous pouvez transporter votre matériel plus rapidement à un coût moins élevé.",
      ExtraText: (
        <>
          <h4>La plus grande gamme d’équipement minier usagé</h4>
          <p>
            Location d’équipement Battlefield offre la plus grande sélection
            ...
            transport, l’équipement minier usagé de Location d’équipement
            Battlefield vous aidera à optimiser votre productivité. L’équipement
            d’exploitation minière d’occasion Caterpillar est réputé pour son
            efficacité, sa traction supérieure et sa rigidité, vous permettant
            de transporter vos matériaux plus rapidement. Contactez Battlefield
            Equipment Rentals aujourd’hui pour obtenir plus d’information sur
            notre équipement minier usagé!
          </p>
        </>
      ),
    },
  },
  {
    ...
    EN: {
      Name: "Motor Graders",
      Meta:
        "Your fleet isn’t complete without a Battlefield Equipment Rentals motor grader. Our used graders provide precise maneuverability in tight spaces and excellent traction on slopes and soft underfoot conditions.",
      Desc: (
        <>
          <h2>Battlefield Equipment Rentals’ Used Motor Graders</h2>
          <p>
            Your fleet isn’t complete without a Battlefield Equipment Rentals
            motor grader. Our used graders provide precise maneuverability in
            tight spaces and excellent traction on slopes and soft underfoot
            conditions. Motor graders can easily travel from point A to point B,
            and can handle multiple jobs in a variety of applications. Their
            invaluable, multi-faceted usage in road paving, construction,
            farming and snow removal applications makes them a truly versatile
            machine.
          </p>
      ...
      ExtraText: (
        <>
          ...
          <p>
            ...
            technology, hydraulics and comfortable cabs. Battlefield Equipment
            Rentals carries used motor graders that range in power from 179 HP
            to 535 HP with blade widths from 12 ft to 24 ft, designed to help
            you get the job done. They also work well on sloped or soft terrain
            and provide excellent maneuvering in small spaces. If you need a
            used motor grader for agricultural, construction, paving or snow
            removal applications, contact Battlefield Equipment Rentals today!
          </p>
        </>
      ),
    },
    FR: {
      Name: "Niveleuses",
      Meta:
        "Votre flotte n’est pas complète sans une niveleuse usagée de Location d’équipement Battlefield. Nos niveleuses d’occasion à vendre fournissent une maniabilité précise dans les espaces restreints et une excellente traction sur les pentes et le sol à faible portance.",
      Desc:
        "Votre flotte n’est pas complète sans une niveleuse usagée de Location d’équipement Battlefield. Nos niveleuses d’occasion à vendre fournissent une maniabilité précise dans les espaces restreints et une excellente traction sur les pentes et le sol à faible portance. Les niveleuses sont complètement polyvalentes, car elles peuvent se déplacer facilement entre les chantiers et peuvent accomplir plusieurs travaux dans une grande variété d’applications, comme celles du pavage, de la construction, de l’agriculture et du déneigement.",
      ExtraText: (
        <>
          ...
          <p>
            ...
            ou de déneigement, contactez Location d’équipement Battlefield
            aujourd’hui!{" "}
          </p>
        </>
      ),
  ...
  },
  {
    ...
    EN: {
      ...
      Meta:
        "Off highway trucks are specifically designed for the mining, quarry and construction industries, where challenging terrain and extreme environments are the norm. In these industries, durability, reliability and load capacity matter the most.",
      Desc: (
        <>
      ...
      ExtraText: (
        <>
          ...
          <p>
            Battlefield Equipment Rentals carries a range of used off-highway
            trucks created specifically to handle mining, construction and
            quarry challenges. Our Caterpillar used off-highway trucks can carry
            payloads between 42.1 ton and 98.4 ton and travel more than 40 mph
            when fully loaded. Caterpillar’s used off-highway trucks are built
            to withstand a variety of environments and terrains and can be
            relied upon to get the job done when it matters most. If your next
            construction, mining or quarry project needs a used off-highway
            truck, contact Battlefield Equipment Rentals today!{" "}
          </p>
        </>
      ),
    },
    FR: {
      ...
      Meta:
        "Les tombereaux rigides sont spécialement conçus pour les industries minières où le terrain est habituellement difficile et les environnements sont extrêmes. Dans ces types d’industries, la durabilité, la fiabilité et la capacité de charge sont d’une grande importance.",
      Desc:
        "Les tombereaux rigides sont spécialement conçus pour les industries minières où le terrain est habituellement difficile et les environnements sont extrêmes. Dans ces types d’industries, la durabilité, la fiabilité et la capacité de charge sont d’une grande importance. Les tombereaux et les tracteurs rigides usagés de Location d’équipement Battlefield sauront dépasser vos atteintes, car ils sont fiables, sécuritaires et économiques, et offrent d’excellentes capacités de transport.",
      ExtraText: (
        <>
          <h4>Une grande gamme de tombereaux rigides et de tracteurs usagés</h4>
          <p>
            Location d’équipement Battlefield offre une gamme de tombereaux
            ...
            nécessite un tombereau rigide, contactez Location d’équipement
  ...
  },
  {
    ...
    EN: {
      ...
      Meta:
        "Our range of used asphalt pavers and rollers will provide economical and versatile solutions for all types of paving needs, from airport and highway projects to small housing developments.",
      Desc: (
        <>
          ...
          <p>
            ...
            and highway projects to small housing developments. Battlefield
            Equipment Rentals’s paving equipment is the ideal choice for
            demanding applications that require fuel efficiency, comfortable
      ...
      ExtraText: (
        <>
          ...
          <p>
            Battlefield Equipment Rentals carries a large selection of used
            ...
            Whatever your paving needs, Battlefield Equipment Rentals has the
            used paving products to get your job done. Contact us for more
    ...
    FR: {
      ...
      Meta:
        "Notre gamme de finisseurs et de rouleaux usagés fournit des solutions économiques et polyvalentes pour tous besoins en matière de pavage, que ce soit pour des projets d’autoroute, d’aéroport ou des développements résidentiels.",
      Desc:
        "Notre gamme de finisseurs et de rouleaux usagés fournit des solutions économiques et polyvalentes pour tous besoins en matière de pavage, que ce soit pour des projets d’autoroute, d’aéroport ou de développement résidentiel. L’équipement de pavage de Location d’équipement Battlefield est le choix idéal pour les applications exigeantes nécessitant une faible consommation de carburant, une opération confortable, une mobilité impressionnante et une fonctionnalité supérieure. Avec notre sélection de finisseurs sur roues ou sur chaînes, votre travail peut atteindre des nouveaux sommets.",
      ExtraText: (
        <>
          <h4>Notre sélection de produits de pavage usagés</h4>
          <p>
            Location d’équipement Battlefield offre une vaste sélection de
            ...
            pouvez compter sur Location d’équipement Battlefield pour les
  ...
  },
  {
    ...
    EN: {
      ...
      Meta:
        "Skid steer loaders are highly adaptable machines. With the use of different attachments, multi terrain loaders can handle a wide range of jobs from snow removal and landscaping to debris removal.",
      Desc: (
        <>
          <h2>Battlefield Equipment Rentals’ Used Skid Steer Loaders</h2>
          <p>
            ...
            jobs from snow removal and landscaping to debris removal.
            Battlefield Equipment Rentals’ used skid steer loaders are primed
            for digging, grading, pushing or loading in almost any kind of
            environment.
          </p>
      ...
      ExtraText: (
        <>
          ...
          <p>
            ...
            applications. Battlefield Equipment Rentals carries several models
            of used skid steer loaders that range in power from 65.8 HP to 106
            HP and have an operating capacity of 1550 lb to 3650 lb. Our used
            Caterpillar skid steer loaders are known worldwide for their
            durability, reliability, efficiency and simple controls. Battlefield
            Equipment Rentals’s used steer loaders are designed and built to
            help you get the job done, so contact us for more information today!
          </p>
        </>
      ),
    },
    FR: {
      ...
      Meta:
        "Les chargeurs compacts rigides sont très adaptables. En utilisant plusieurs accessoires différents, les chargeurs tout terrain peuvent accomplir un large éventail de travaux comme le déneigement, l’aménagement paysager et l’élimination des débris.",
      Desc:
        "Les chargeurs compacts rigides sont très adaptables. En utilisant plusieurs accessoires différents, les chargeurs tout terrain peuvent accomplir un large éventail de travaux comme le déneigement, l’aménagement paysager et l’élimination des débris. Les chargeurs compacts rigides usagés de Location d’équipement Battlefield sont prêts à creuser, à niveler, à pousser ou à transporter dans n’importe quel type d’environnement. Nos petits chargeurs sont idéals pour les travaux d’intérieur ou les espaces étroits, tandis que nos gros chargeurs sont parfaits pour les grands travaux d’extérieur tels que la démolition et l’exploitation forestière.",
      ExtraText: (
        <>
          <h4>
          ...
          <p>
            ...
            d’accessoires Cat pour différentes applications. Battlefield
            Equipment Rentals offre plusieurs modèles de chargeurs compacts
            ...
            chargeurs compacts rigides d’occasion de Battlefield Equipment
            Rentals sont conçus pour faciliter tout type de travail, alors
            contactez-nous aujourd’hui pour obtenir plus d’information!
          </p>
        </>
      ),
    },
  },
  {
    ...
    EN: {
      Name: "Telehandlers",
      Meta:
        "With Battlefield Equipment Rentals’ used telehandlers, nothing is out of reach. Our line of telescopic lifts add unmatched versatility and ease of handling to any industry application.",
      Desc: (
        <>
          <h2>
            Battlefield Equipment Rentals’ Selection of Used Telehandlers{" "}
          </h2>
          <p>
            Battlefield Equipment Rentals’ selection of Used Telehandlers With
            Battlefield Equipment Rentals’ used telehandlers, nothing is out of
            reach. Our line of telescopic lifts add unmatched versatility and
            ease of handling to any industry application. Telehandlers can
            operate where forklifts and conventional equipment cannot, offering
            extra stability on steep or rough terrain, durability for heavy load
            handling, and optimal lift and reach capabilities for hard-hitting
            results.
          </p>
      ...
      ExtraText: (
        <>
          ...
          <p>
            Battlefield Equipment Rentals’ used telehandlers by Caterpillar are
            easily maneuverable and versatile for use in a variety of
            ...
            Battlefield Equipment Rentals for more information today!
          </p>
        </>
      ),
    },
      ...
      ExtraText: (
        <>
          ...
          <p>
            ...
            télescopique de Location d’équipement Battlefield sont spécialement
            conçus pour les terrains et les travaux rigoureux. Si votre prochain
            projet ou chantier nécessite un chargeur à bras télescopique fiable,
            durable et puissant, contactez Location d’équipement Battlefield
            aujourd’hui pour obtenir plus d’information!
          </p>
        </>
      ),
    },
  },
  {
    ...
    EN: {
      ...
      Meta:
        "When it comes to top loading and digging performance on the job site, nothing  beats our used track type loaders/crawlers.",
      Desc: (
        <>
          <h2>
      ...
      ExtraText: (
        <>
          <h4>
            Battlefield Equipment Rentals’ Selection of Used Track Type Loaders
            and Crawlers{" "}
          </h4>
          <p>
            ...
            loader/crawler, contact Battlefield Equipment Rentals today for more
            information about our available models.
          </p>
        </>
      ),
    },
    FR: {
      ...
      Meta:
        "Nos chargeurs sur chaînes usagés offrent une puissance de creusement et de chargement supérieure sur le chantier.",
      Desc:
        "Nos chargeurs sur chaînes usagés offrent une puissance de creusement et de chargement supérieure sur le chantier. Les chargeurs sur chaînes de Location d’équipement Battlefield sont conçus pour maîtriser les terrains les plus rigoureux. Ils fournissent une puissance et une polyvalence inégalées grâce à leur étonnante capacité à creuser et à charger dans les applications les plus difficiles telles que l'exploitation minière, la carrière et la construction.",
      ExtraText: (
        <>
          <h4>
            La sélection de chargeurs sur chaines usagés de Battlefield
            Equipment Rentals
          </h4>
          <p>
            Location d’équipement Battlefield offre plusieurs modèles de
            ...
            robuste, contactez Location d’équipement Battlefield aujourd’hui
  ...
  },
  {
    ...
    EN: {
      ...
      Meta:
        "Dozers are a force to be reckoned with when it comes to achieving peak mobility on difficult terrain. Our used track type tractors deliver earth-moving power thanks to their excellent tractive force and maneuverability.",
      Desc: (
        <>
      ...
      ExtraText: (
        <>
          ...
          <p>
            Battlefield Equipment Rentals has a range of Caterpillar’s used
            ...
            agricultural, construction, mining or quarry project, Battlefield
            Equipment Rentals can help you find the right for your needs.
            Contact Battlefield Equipment Rentals today for more information
            about our selection of used track type tractors or dozers!
          </p>
        </>
      ),
    },
    FR: {
      ...
      Meta:
        "En matière de performance et de mobilité sur les terrains difficiles, rien ne bat les bulldozers usagés à vendre de Location d’équipement Battlefield. Grâce à leur maniabilité et à leur superbe capacité de traction, nos dozers usagés offrent une puissance qui fait secouer la terre.",
      Desc:
        "En matière de performance et de mobilité sur les terrains difficiles, rien ne bat les bulldozers usagés à vendre de Location d’équipement Battlefield. Grâce à leur maniabilité et à leur superbe capacité de traction, nos dozers usagés offrent une puissance qui fait secouer la terre. Utilisés sur une variété de chantiers tels que les fermes, les mines, les carrières et la construction, les tracteurs sur chaines peuvent efficacement pousser de la terre, du sable et d’autres matériaux pour fournir un haut niveau de productivité et de performance dans toutes sortes d’applications.",
      ExtraText: (
        <>
          <h4>Grande gamme de tracteurs sur chaines usagés</h4>
          <p>
            Location d’équipement Battlefield offre une sélection de petits,
            ...
            d’agriculture, de construction ou de carrière, Battlefield Equipment
            Rentals peut vous aider à trouver la machine la mieux adaptée à vos
            besoins. Contactez Location d’équipement Battlefield aujourd’hui
            pour obtenir plus d’information sur notre sélection de tracteurs sur
            chaines usagés!
          </p>
        </>
      ),
  ...
  },
  {
    ...
    EN: {
      ...
      Meta:
        "When choosing the right wheel loader, configuration is key. With a wide range of loaders from Battlefield Equipment Rentals, selecting the best type of equipment for each specific application is fast and simple. Our wheel loaders deliver excellent fill factors, improved cycle times and better visibility.",
      Desc: (
        <>
          <h2>Wide Selection of Used Cat Wheel Loaders</h2>
          <p>
            With Battlefield Equipment Rentals’ range of Used Compact Wheel
      ...
      ExtraText: (
        <>
          ...
          <p>
            ...
            jobs in a shorter amount of time. Battlefield Equipment Rentals used
            wheel loaders for sale are also outfitted with premium ergonomic
            cabs and options such as engine and ground speed control, which
            provide customizable control when operating work tools.
          </p>
        </>
      ),
    },
      ...
      ExtraText: (
        <>
          ...
          <p>
            ...
            d’occasion à vendre de Location d’équipement Battlefield sont aussi
            équipés de cabines ergonomiques et d’options telles que le contrôle
            du moteur et de la vitesse au sol, fournissant un contrôle
  ...
  },
  {
    ...
    EN: {
      Name: "Work Tools",
      Meta:
        "The right tools will do the right job. Battlefield Equipment Rentals offers a wide assortment of used work tools suited for all types of applications, from landscaping to snow removal.",
      Desc:
        "The right tools will do the right job. Battlefield Equipment Rentals offers a wide assortment of used work tools suited for all types of applications, from landscaping to snow removal. We carry used buckets, augers and forks, as well as breakers, compactors and snow removal. Getting your hands on our cost-friendly work tools will ensure flexibility and peak performance on the job site.",
      ExtraText: null,
    },
    FR: {
      Name: "Outils De Travail",
      Meta:
        "Les bons outils font un bon travail. Location d’équipement Battlefield offre un grand assortiment d’outils de travail usagés qui sont adaptés à plusieurs types d’applications comme le déneigement et le travail forestier.",
      Desc:
        "Les bons outils font un bon travail. Location d’équipement Battlefield offre un grand assortiment d’outils de travail usagés qui sont adaptés à plusieurs types d’applications comme le déneigement et le travail forestier. Nous offrons des godets, des têtes d’abattage et des fourches ainsi que des outils pour concasseurs, compacteurs et équipement de déneigement. Nos outils de travail à prix budgétaires vous aideront à atteindre une meilleure performance et flexibilité sur le chantier.",
      ExtraText: null,
    },
  },
  {
    ...
    EN: {
      Name: "Generators",
      Meta:
        "Battlefield Equipment Rentals carries a wide selection of used commercial and industrial generators. Our used gas and diesel generators are built to world-class standards, for high efficiency and low fuel consumption. Contact us today for more information!",
      Desc: (
        <>
          <p>
            ...
            power complex business data centers and hospitals. Battlefield
            Equipment Rentals carries a large selection of used generators for
            commercial and industrial applications that range in power from 40
            kW to 2,000 kW. We guarantee that our Caterpillar used generators
            are load tested and regularly serviced to ensure that you can use
            your generator immediately after purchase. Whether you need a used
            generator for your job site or business, contact Battlefield
            Equipment Rentals today for more information about our used
            generator range.
          </p>
      ...
      ExtraText: (
        <>
          ...
          <p>
            Battlefield Equipment Rentals carries a wide selection of used
    ...
    FR: {
      ...
      Desc: (
        <>
          <p>
            ...
            et des centres complexes de données d’entreprise. Battlefield
            Equipment Rentals offre une large sélection de groupes électrogènes
            ...
            contacter Location d’équipement Battlefield aujourd’hui pour obtenir
            plus d’information sur notre sélection de groupes électrogènes.
          </p>
      ...
      ExtraText: (
        <>
          ...
          <p>
            Location d’équipement Battlefield offre une large sélection de
      ...
      Desc: (
        <>
          <p>
            ...
            miniers, d’agriculture et de construction à travers le Canada. Ils
            sont aussi souvent utilisés pour alimenter des centres hospitaliers
            et des centres complexes de données d’entreprise. Location
            d’équipement Battlefield offre une large sélection de groupes
            ...
            entreprise, veuillez contacter Location d’équipement Battlefield
